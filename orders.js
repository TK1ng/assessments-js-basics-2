...
class Ticket {
    ...
    updateStatus(newStatus) {
        ...
        console.log(`The order for custom ${this.customerId} is now ${this.status}`)
    }
...
const firstTicket = new Ticket(['bbq jackfruit burger', 'mashed potatoes', 'habiscus lemonade'], '7:03 PM', 555);
